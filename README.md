...
Note: the code for this solution is developed based on phone numbers and long code as the  supported origination identity in Australia. You need to adjust the Lambda code accordingly for this to work in your country.
...
Follow the below step 1 – 5 outlined in Set up two-way SMS messaging for a phone number in AWS End User Messaging SMS, for step 6:
